...
public class PersonalArea extends AppCompatActivity
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            //bottoni
/*
            Button buttonSpesePersonali = findViewById( R.id.buttonSpesePersonali );

            buttonSpesePersonali.setOnClickListener( new View.OnClickListener() {
                @Override
            ...
            Button buttonModificaProfilo = findViewById( R.id.buttonModificaProfilo );

            buttonSpesePersonali.setOnClickListener( new View.OnClickListener() {
                @Override
                public void onClick(View arg0) {

                    Intent intent = new Intent(getBaseContext(), ModificaProfilo.class);
                    startActivity(intent);
                }
            } );
*/
        ...
        public boolean onNavigationItemSelected(MenuItem item) {
            ...
            if (id == R.id.nav_casa) {
                ...
                Intent searchIntent2 = new Intent(PersonalArea.this, PersonalArea.class);
